...
|0.5.8|`./dynamic-plugins/dist/backstage-plugin-catalog-backend-module-bitbucket-cloud`
...
|0.5.8|`./dynamic-plugins/dist/backstage-plugin-catalog-backend-module-bitbucket-server`
...
|*Dynatrace*
|10.16.0|`./dynamic-plugins/dist/backstage-community-plugin-dynatrace`
...
|0.2.18|`./dynamic-plugins/dist/backstage-plugin-scaffolder-backend-module-azure`
...
|0.3.3|`./dynamic-plugins/dist/backstage-plugin-scaffolder-backend-module-bitbucket-cloud`
...
|0.2.18|`./dynamic-plugins/dist/backstage-plugin-scaffolder-backend-module-bitbucket-server`
...
|0.2.18|`./dynamic-plugins/dist/backstage-plugin-scaffolder-backend-module-gerrit`
