...
|1.23.1|`./dynamic-plugins/dist/backstage-community-plugin-nexus-repository-manager`
...
|*SonarQube Backend*
|1.1.0|`./dynamic-plugins/dist/backstage-community-plugin-sonarqube-backend`
