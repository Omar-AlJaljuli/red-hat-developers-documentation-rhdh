...
The following table lists all 45 community-supported plugins that have been migrated from bundled wrappers to `ghcr.io`.
...
|0.18.0|`./dynamic-plugins/dist/bcp-ctlg-backend-mod-azure-devops-annotator-processor`
...
|0.5.9|`./dynamic-plugins/dist/backstage-plugin-catalog-backend-module-bitbucket-cloud`
...
|0.5.9|`./dynamic-plugins/dist/backstage-plugin-catalog-backend-module-bitbucket-server`
...
|0.11.0|`./dynamic-plugins/dist/backstage-community-plugin-search-backend-module-github-discussions`
...
|*GitHub Issues*
|0.21.0|`./dynamic-plugins/dist/backstage-community-plugin-github-issues`
|`oci://ghcr.io/redhat-developer/rhdh-plugin-export-overlays/backstage-community-plugin-github-issues:<tag>`

|*GitHub Pull Requests*
|3.7.0|`./dynamic-plugins/dist/roadiehq-backstage-plugin-github-pull-requests`
...
|0.20.0|`./dynamic-plugins/dist/bcp-scaffolder-backend-mod-jenkins`
...
|0.3.10|`./dynamic-plugins/dist/pagerduty-backstage-plugin-entity-processor`
...
|0.2.9|`./dynamic-plugins/dist/pagerduty-backstage-plugin-scaffolder-actions`
|`oci://ghcr.io/redhat-developer/rhdh-plugin-export-overlays/pagerduty-backstage-plugin-scaffolder-actions:<tag>`

|*Quay Backend*
|1.14.0|`./dynamic-plugins/dist/backstage-community-plugin-quay-backend`
...
|4.8.0|`./dynamic-plugins/dist/roadiehq-backstage-plugin-argo-cd-backend`
...
|0.2.19|`./dynamic-plugins/dist/backstage-plugin-scaffolder-backend-module-azure`
...
|0.23.0|`./dynamic-plugins/dist/bcp-scaffolder-backend-mod-azure-devops`
...
|0.3.4|`./dynamic-plugins/dist/backstage-plugin-scaffolder-backend-module-bitbucket-cloud`
...
|0.2.19|`./dynamic-plugins/dist/backstage-plugin-scaffolder-backend-module-bitbucket-server`
...
|0.13.0|`./dynamic-plugins/dist/bcp-scaffolder-backend-mod-dotnet`
...
|0.2.19|`./dynamic-plugins/dist/backstage-plugin-scaffolder-backend-module-gerrit`
...
|2.18.0|`./dynamic-plugins/dist/backstage-community-plugin-scaffolder-backend-module-quay`
...
|2.15.1|`./dynamic-plugins/dist/backstage-community-plugin-scaffolder-backend-module-servicenow`
...
|2.15.0|`./dynamic-plugins/dist/backstage-community-plugin-scaffolder-backend-module-sonarqube`
...
|0.5.0|`./dynamic-plugins/dist/bcp-search-backend-mod-azure-devops`
...
|*SonarQube Backend*
|1.1.1|`./dynamic-plugins/dist/backstage-community-plugin-sonarqube-backend`
|`oci://ghcr.io/redhat-developer/rhdh-plugin-export-overlays/backstage-community-plugin-sonarqube-backend:<tag>`

|*Tekton*
|3.37.0|`./dynamic-plugins/dist/backstage-community-plugin-tekton`
