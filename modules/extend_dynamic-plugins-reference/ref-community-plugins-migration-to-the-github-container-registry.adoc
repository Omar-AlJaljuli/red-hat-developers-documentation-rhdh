...
The following table lists all 44 community-supported plugins that have been migrated from bundled wrappers to `ghcr.io`.
...
|2.15.0|`./dynamic-plugins/dist/backstage-community-plugin-scaffolder-backend-module-servicenow`
